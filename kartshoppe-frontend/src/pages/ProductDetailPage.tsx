      ...
      <div className="card p-8">
          ...
          <div className="card p-6">
            ...
            <dl className="space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <dd className="font-medium">{(Math.random() * 5 + 0.5).toFixed(1)} lbs</dd>
              </div>
              <div className="flex justify-between">
            ...
            <div className="card p-6">
              ...
              {[5, 4, 3, 2, 1].map((stars) => (
                <div key={stars} className="flex items-center mb-1">
                  ...
                  <span className="text-sm text-gray-600 w-10">{stars === 5 ? 60 : stars === 4 ? 25 : stars === 3 ? 10 : 5}%</span>
                </div>
              ))}
            </div>
              ...
              {[1, 2, 3].map((review) => (
                <div key={review} className="border-b pb-4">
                  <div className="flex items-center mb-2">
                    ...
                    <span className="ml-2 text-sm font-medium">Customer {review}</span>
                    <span className="ml-auto text-sm text-gray-500">{review} days ago</span>
                  </div>
                  <p className="text-gray-700">Great product! Exactly as described and arrived quickly. The real-time inventory tracking gave me confidence in my purchase.</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="mt-8 pt-8 border-t text-center">
          <p className="text-sm text-gray-500">
            Powered by Apache Flink & Apache Paimon for real-time inventory management
          </p>
        </div>
      </div>
    </div>
